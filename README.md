...
After the installation of ANTs and FSL, you need to create a new Python3 venv ([link](https://docs.python.org/3/library/venv.html)). Activate the newly created virtual environment, then `cd` into the directory where `setup.py` is located, and type:
